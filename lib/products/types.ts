...
export interface Product {
  ...
  /* ── حقول الكتيب الرقمي (تُستخدم فقط في صفحة الكتيب — تصنيف "كتب ودلائل") ── */
  /** الخطّاف الافتتاحي — فقرة تشويقية أعلى الصفحة */
  bookletHook?: string;
  /** نبذة عن الكتيب — فقرات */
  bookletAbout?: string[];
  /** "ماذا ستجدين داخل الكتيب؟" — قائمة المواضيع/الفصول */
  bookletChapters?: string[];
  /** "ماذا سيفيدك هذا الكتيب؟" — قائمة الفوائد */
