 ...
 * فالحقل الذي تتركه فارغًا يعني «لا تعرض هذا العنصر»، ولا يُعاد ملؤه من الكود.
 * بهذا يعمل فعلًا ما وعدت به الحقول: «أفرغي الرابط ليختفي من الفوتر».
 *
 ...
 *
 * والكتلة الغائبة كليًا (لم تُلمس في Studio) تعود للافتراضي كاملةً.
 */
