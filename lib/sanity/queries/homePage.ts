...
export const DEFAULT_HOME: HomePageContent = {
  ...
  heroIntro:
    "تأسست Momzy على يد هبة حسن — ممرضة معتمدة ومرافقة ولادة، رافقت آلاف الأمهات برحلتهنّ.",
  heroPoints: [
  ...
  whyIntro:
    "كل شي بدأ من قلب التجربة. هبة حسن — ممرضة معتمدة ومرافقة ولادة — رافقت آلاف الأمهات، وآمنت إنّ كل أم تستحق دعمًا حقيقيًا بأهم مرحلة في حياتها. هيك وُلدت Momzy.",
  whyValues: [
  ...
  hebaBio: [
    "ممرضة شغوفة بالأمومة، رحلتها مع آلاف الأمهات منحتها فهماً عميقاً لما تحتاجه كل أم. هبة لا تقدم معلومات فقط — تقدم حضوراً إنسانياً حقيقياً.",
    "من أول نبضة قلب حتى الخطوة الأولى لطفلك — هبة بجانبك بعلم وحب وشغف حقيقي.",
  ],
  hebaSignature: "هبة حسن",
  hebaStat: { number: "آلاف", label: "أمّ رافقتهنّ" },
