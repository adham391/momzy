...
const DEFAULTS: Record<AppLocale, AboutPageContent> = {
  ...
  ar: {
    ...
    name: "هبة حسن",
    tagline:
      "ممرضة شغوفة بالأمومة، رافقت +1000 أم وأطفالهنّ — تقدّم معرفةً دقيقة ودعمًا إنسانيًا مبنيًا على تجربة ميدانية حقيقية.",
    ...
    storyLabel: "قصتها",
    storyQuote:
      "«بدأت Momzy من قلب التجربة — لأني آمنت أن كل أم تستحق دعمًا حقيقيًا في أهم مرحلة بحياتها.»",
    storyParagraphs: [
      "هبة حسن مؤسِّسة منصة Momzy، انطلقت من خبرة ميدانية حقيقية في مرافقة الأمهات. بفهم عميق لاحتياجات الأم في مراحلها المختلفة، تقدّم هبة معرفة دقيقة ودعمًا حقيقيًا مبنيًا على تجربة واقعية.",
