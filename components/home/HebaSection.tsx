...
export default function HebaSection() {
  return (
    <section className="py-11 bg-cream relative overflow-hidden">
      {/* دوائر ديكورية */}
      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center relative z-[2]">
          ...
          <div className="text-center">
            ...
            {/* الاسم */}
            <div className="font-heading text-[28px] text-dark mb-1">
              هبة حسن
            </div>
            <div className="font-label text-sm text-light tracking-[2px] uppercase mb-5">
              Heba Hasan
            </div>
          ...
          <div>
            ...
            <p className="text-[15px] leading-[1.85] text-mid mt-4 mb-3.5">
              ممرضة شغوفة بالأمومة، رحلتها مع أكثر من ألف أم منحتها فهماً
              عميقاً لما تحتاجه كل أم. هبة لا تقدم معلومات فقط — تقدم حضوراً
              إنسانياً حقيقياً.
            </p>
            <p className="text-[15px] leading-[1.85] text-mid mb-8">
              من أول نبضة قلب حتى الخطوة الأولى لطفلك — هبة بجانبك بعلم وحب
              وشغف حقيقي.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {HEBA_SERVICES.map((svc) => (
                ...
                >
                  ...
                  <div>
                    <div className="text-[13px] font-bold text-dark mb-0.5">
                      {svc.title}
                    </div>
                    <div className="text-[11px] text-light leading-[1.5]">
                      {svc.description}
                    </div>
                  </div>
                </div>
            ...
            {/* زر CTA */}
            <div className="mt-7">
              <Button variant="rose" href="/services">
                احجزي مع هبة ←
              </Button>
            </div>
          </div>
