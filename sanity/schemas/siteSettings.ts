    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          description: "كلمة صغيرة بخلفية وردية (اختياري)",
        }),
        defineField({
          name: "message",
          title: "رسالة الشريط",
          type: "string",
          placeholder: "مثال: صندوق مشوار أم — اطلبي الآن قبل نفاد الكمية",
        }),
        defineField({
    ...
    defineField({
      ...
      fields: [
        defineField({
          ...
          type: "string",
          placeholder: "نحن هنا للمساعدة في كل خطوة من رحلتك",
        }),
        defineField({
          name: "description",
          title: "الوصف",
          type: "text",
          rows: 2,
          placeholder: "مؤسسة متخصصة ترافق الأمهات — خدمات، منتجات، ومحتوى لكل أم.",
        }),
        defineField({
          name: "copyright",
          title: "حقوق النشر",
          type: "string",
          placeholder: "© 2026 Momzy — جميع الحقوق محفوظة",
        }),
      ],
    }),
  ],
