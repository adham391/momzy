...
export const service = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "number",
      description:
        "ما تدفعه الزائرة من خارج البلاد بالدولار لكل جلسة (للّقاءات الأونلاين — الحضوري من داخل البلاد فقط). إن تُرك فارغًا يُحوَّل سعر الشيكل بسعر 3.6.",
      validation: (r) => r.min(0),
    }),
    ...
    defineField({
      ...
      initialValue: false,
      description:
        "للّقاءات الفردية — يُضاف لنموذج التسجيل خانة إلزامية تكتب فيها الأم موضوع الاستشارة أو اللقاء، " +
        "ويصلكِ ما كتبته في لوحة الحجوزات وفي إيميل الحجز.",
    }),
